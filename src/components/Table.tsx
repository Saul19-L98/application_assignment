        ...
        <>
            ...
            <div className={`modal modal-bottom sm:modal-middle ${showModal ? "modal-open" : ""}`}>
                <div className="modal-box">
                    ...
                    <div className="card">
                        <div className='flex'>
                            <p><span className='text-lg text-orange-200'>Employee: </span>{modalData.name}</p>
                        </div>
                        <div>
                            <p><span className='text-lg text-orange-200'>Doctor's Name: </span>{modalData.nDoctor}</p>
                        </div>
                        <div>
                            <p><span className='text-lg text-orange-200'>Diagnostic: </span>{modalData.diagnostic}</p>
                        </div>
                        <div>
                            <p><span className='text-lg text-orange-200'>Coverage Days: </span>{modalData.coverage}</p>
                        </div>
                        <div>
                            <p><span className='text-lg text-orange-200'>Start Date: </span>{modalData.sDate}</p>
                        </div>
                        <div>
                            <p><span className='text-lg text-orange-200'>End Date: </span>{modalData.eDate}</p>
                        </div>
                    </div>
